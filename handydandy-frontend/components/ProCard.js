    ...
    <div className="flex justify-center min-w-full">
      <div className="max-w-md px-8 py-4 my-20 bg-white rounded-lg shadow-lg">
        <div className="flex justify-center -mt-16 md:justify-end">
          <img className="object-cover w-20 h-20 border-2 border-mediumBlue rounded-full" src="https://images.unsplash.com/photo-1581783898377-1c85bf937427?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=715&q=80" />
        </div>
        <div>
          <h2 className="text-2xl font-semibold text-center text-black">{props.pro.name}</h2>
          <p className="mt-2 mb-2 text-black">Proficient in</p>
